function generarTablaResultadosRR(gridMap) {
    let html = `
    ...
    const tiempoProcesos = allNodes.filter(n => n.color === "green").length;
    ...
    html += `
        <table class="resultado-table">
            <tbody>
                ...
                <tr><td><b>Tiempo Procesos</b></td><td>${tiempoProcesos}</td></tr>
                <tr><td><b>Tiempo Sistema</b></td><td>${tiempoSistema}</td></tr>
                <tr><td><b>%CPU Procesos</b></td><td>${cpuProcesos}</td></tr>
                <tr><td><b>%CPU Sistema</b></td><td>${cpuSistema}</td></tr>
